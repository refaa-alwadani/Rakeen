...
if (isset($_SESSION['user_m']) AND $_SESSION['user_m'] != '') {
...
<b style="color:black; font-size:15px; "> New registration for the institution </b>
                <form action="signupm.php?action=submit" method="POST">
...
function signUp() {
	...
	$query = "INSERT INTO rootm (name_company,field,city_m,city_m2,user_m,pass_m,email_m) VALUES (
	'" . mysqli_real_escape_string($conn_link, $_POST['name_company']) . "',
	'" . mysqli_real_escape_string($conn_link, $_POST['field']) . "',
	'" . mysqli_real_escape_string($conn_link, $_POST['city_m']) . "',
	'" . mysqli_real_escape_string($conn_link, $_POST['city_m2']) . "',
	'" . mysqli_real_escape_string($conn_link, $_POST['user_m']) . "','" . sha1($_POST['pass_m']) . "','" . mysqli_real_escape_string($conn_link, $_POST['email_m']) . "')";
